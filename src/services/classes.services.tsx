...
export const update = async (data:any) => {
  ...
  export const relationClassByTeacher = async (id:number, data:any) => {
    try {
      
      const response = await axiosInstance.post(`${ENPOINT}/${id}/assign-teacher`, {...data});
      return response.data;
    } catch (error:any) {
      return error?.response.data;
    }
